...
class Elastic(DataLayer):
    ...
    def reindex(self, resource, *, requests_per_second=1000):  # noqa: F811
        ...
        es.indices.create(index=tmp_index, body={
            "mappings": old_mappings[old_index]["mappings"] if old_mappings else {},
            "aliases": {
                alias: {
                    "is_write_index": True,
                },
